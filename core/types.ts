// The contract Lane B (the app) builds against. Implemented by core/index.ts.
// These shapes are FROZEN — real engine implementations land behind exactly these types.
